            ...
            <div className="col-md-6">
              <div className="about_taital_main">
                ...
                <p className="about_text">
                  Welcome to Visby, one of the most unique cities in Sweden,
                  where every corner feels like a journey back in time. Step
                  into the past as you wander through streets like Fiskargränd,
                  frozen in the charming essence of the 1600s. It's a fairy tale
                  come to life, with climbing roses adorning the facades,
                  beckoning you to explore its enchanting alleys.
                </p>
                <p className="about_text">
                  {" "}
                  If you have a penchant for nature and flowers, Botaniska
                  trädgården awaits. Lose yourself in the meticulously kept
                  gardens, where each step rejuvenates your soul and fills your
                  heart with tranquillity.
                </p>
                <p className="about_text">
                  {" "}
                  For history buffs, Väktargången and the St. Nicolai ruin stand
                  as poignant reminders of bygone eras, meticulously preserved
