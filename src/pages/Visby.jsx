          ...
          <div className="row align-items-center ">
            <div className="col-md-6">
              <div className="about--title-main">
                <h2 className="about--title">Visby</h2>
                ...
                <p className="about--text">
                  If you have a <strong>penchant for nature and flowers, </strong>
                ...
                <p className="about--text">
                  <strong>For history buffs</strong>, <a href="https://maps.app.goo.gl/5oxFVNcrJcMy4SW39" target="_blank"> Visby Ringmur </a> 
                  and the 
