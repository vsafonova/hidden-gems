          ...
          <div className="row">
            <div className="col-md-6">
              <div className="about_taital_main">
                ...
                <p className="about_text">
                  {" "}
                  In the winter months, Järvsö transforms into a skier's
                  paradise with its Järvsöbacken boasting 23 diverse hills
                ...
                <p className="about_text">
                  ...
                  descents and exhilarating trails. For those seeking a
                  different kind of adventure, immerse yourself in the heart of
                  Swedish nature at Vildriket, a unique zoo where you stroll
                  through the forest, seamlessly blending into the natural
                  habitat alongside majestic creatures like lynxes and snow
                  foxes.{" "}
                </p>{" "}
                <p className="about_text">
                  When it's time to eat, we recommend Järvsö Creperie, a small
                  and charming spot that offers both savoury and sweet crepes.
                  How about a crêpe with local cloudberries and a generous scoop
                  of vanilla – a true taste of the region's flavours.
                </p>
                <p className="about_text">
                  {" "}
                  And for connoisseurs of architecture and serene sanctuaries,
